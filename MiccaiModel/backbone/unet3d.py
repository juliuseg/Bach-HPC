...
if __name__ == '__main__':
    ...
    # Initialize the UNet model and move it to the selected device
    net = UNet(residual='conv').to(device).eval()

    # Define dummy input data and move it to the selected device
    data = torch.randn(1, 1, 64, 700, 64).to(device)
    ...
    summary(net, input_size=(1, 1, 64, 700, 64), device=device)
